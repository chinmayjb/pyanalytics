...
mtcarsDF.select_dtypes(include=['int64', 'float64'])
mtcarsDF.isna()
mtcarsDF.notna()
id(mtcarsDF)
mtcars.empty
...
mtcars.size
mtcars.ndim
mtcars.axes#it is the row names and column names
mtcars.values
...
mtcarsDF[0:5]
mtcarsDF[7:10:2] #for every alternate value
mtcarsDF.loc[:,'mpg']
...
mtcarsDF.index
mtcarsDF.loc[['Mazda RX4']] #Error rectified instead of 4x4
mtcarsDF.loc['Mazda RX4', ['mpg']] #error
...
mtcarsDF.sort_values(by='wt').plot(x='wt', y='mpg') #sorted based on weight
